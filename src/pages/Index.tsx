...
const whyChooseReasons = [
  ...
  {
    icon: Building2,
    title: "ניסיון קליני רחב מבתי חולים מובילים",
    description: "ידע רפואי עדכני וניסיון מקצועי שנצבר בעבודה במרכזים רפואיים בארץ ובארה\"ב.",
  },
  {
    icon: MessageCircle,
    title: "ליווי אישי לאורך הבירור והטיפול",
    description: "גישה אישית ומסודרת המסייעת להבין את הבירור, את אפשרויות הטיפול ואת הצעדים הבאים.",
  },
];
const goldenGuides = [
  {
...
const faqItems = [
  {
    ...
    answer: "כאשר מופיעה תגובה חוזרת למזון, תרופה או עקיצה, פריחה לא מוסברת, או תסמיני אסתמה ונזלת כרונית. בירור אצל רופא אלרגיה מומחה יכול לסייע בזיהוי הגורם, בהערכת הסיכון ובהתאמת תכנית טיפול והנחיות להמשך.",
  },
  {
  ...
  },
  {
    ...
    answer: "השיטות העיקריות כוללות תבחיני עור (Skin Prick Test), שבדרך כלל נקראים במהלך הביקור, ובדיקות דם לנוגדני IgE ספציפיים, שזמן קבלת תוצאותיהן תלוי במעבדה. במצבים מסוימים נשקל גם תגר מזון מבוקר, בהתאם להערכה הרפואית ולמסגרת המתאימה.",
  },
];
  ...
  return (
    <>
      <Helmet>
        ...
        <meta name="description" content="ד״ר אנה ברמלי, מומחית לאלרגיה ואימונולוגיה בהוד השרון. אבחון וטיפול באלרגיה למזון, אסתמה, נזלת אלרגית, אלרגיה לתרופות ואנפילקסיס - לילדים ולמבוגרים." />
        ...
        <div className="container-medical">
          ...
          >
            ...
            <p className="text-muted-foreground text-lg max-w-2xl mx-auto">
              {whySection?.content || ' בוגרת לימודי רפואה באוניברסיטת בן גוריון בנגב והתמחות ברפואת ילדים בבית החולים שניידר. את תת ההתמחות באלרגיה ואימונולוגיה קלינית השלימה בארה"ב בבית החולים Vanderbilt University Medical Center ושבה כרופאה בכירה למכון האלרגיה בבית החולים שניידר לרפואת ילדים.'}
            </p>
          </motion.div>
