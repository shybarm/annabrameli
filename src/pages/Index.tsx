          ...
          <div className="grid lg:grid-cols-2 gap-12 lg:gap-20 items-center">
            ...
            >
              ...
              <p className="text-lg md:text-xl text-muted-foreground leading-relaxed mb-6 max-w-2xl">
                בוגרת לימודי רפואה באוניברסיטת בן גוריון בנגב והתמחות ברפואת ילדים בבית החולים שניידר. את תת ההתמחות באלרגיה ואימונולוגיה קלינית סיימה בארה"ב בבית החולים Vanderbilt University Medical Center ושבה כרופאה בכירה למכון האלרגיה בבית החולים שניידר לרפואת ילדים.
              </p>
