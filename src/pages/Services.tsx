...
const servicesFaqs = [
  ...
  { question: "איך לבחור את האלרגולוג המתאים לפרטיות בישראל?", answer: "כדאי לבחון ניסיון, התמחויות ומדיניות תורים/תמיכה. חשוב לאיש קשר רפואי ברור ולגישה מותאמת." },
  { question: "האם יש תסמינים נפוצים של אלרגיה שאפשר לזהות בבית?", answer: "נזלת אלרגית, קוצר נשימה ופריחה יכולים להתרחש בתקופות שונות. מוטב לפנות לבדיקת אלרגיה כדי לזהות את הגורם ולגבש תכנית טיפול." },
  { question: "מה עושים אם מופיעים תסמינים חריפים או נפיחות?", answer: "במקרה של קוצר נשימה, פריחה מפושטת או תגובה חריפה - יש לפנות לקבלת טיפול דחוף. כאשר התסמינים חוזרים, כדאי לפנות לרופא אלרגיה לייעוץ." },
  { question: "מה כולל התהליך כשמתאמים פנייה לד\"ר אנה ברמלי?", answer: "התהליך מתחיל בקליניקה עם סקירה והגדרת מטרות הבדיקה, ולאחר מכן תכנון מעקב ובדיקות מתאימות." },
];
