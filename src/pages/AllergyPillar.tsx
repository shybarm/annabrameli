...
const faqs = [
  ...
  },
  {
    ...
    answer:
      "הזמינות, העלות, ההסדרים ומקום ביצוע הבדיקות משתנים בין קופות, בתי חולים ומרפאות פרטיות. בשני המסלולים חשוב שהבירור יתחיל בסיפור הרפואי ושהבדיקות ייבחרו לפי החשד הקליני. מומלץ לברר מראש מה כלול בביקור ומה זמינות השירות בפועל.",
