...
const faqs = [
  ...
  },
  {
    ...
    answer: "מסלול פרטי עשוי להתאים כאשר חשוב לבחור את הרופא או לקבל בירור ומעקב במסגרת מסוימת. זמינות התור, משך הביקור, הבדיקות והעלות משתנים, ולכן כדאי לברר מראש מה כלול בכל מסלול.",
  },
  {
