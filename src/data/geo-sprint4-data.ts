...
export const TOPIC_CLUSTERS: TopicCluster[] = [
  {
    ...
    pages: [
      { path: '/אלרגיה-בילדים-מדריך-מלא', titleHe: 'אלרגיה בילדים - מדריך מלא', role: 'pillar', intent: 'definition', geoScore: 8, linksTo: ['/knowledge/במבה-גיל-4-חודשים', '/knowledge/תגר-מזון-איך-זה-נראה'], linksMissing: ['/knowledge/בדיקת-דם-לאלרגיה-ילדים'] },
      { path: '/knowledge/תגר-מזון-איך-זה-נראה', titleHe: 'אתגר מזון אוראלי', role: 'supporting', intent: 'diagnosis', geoScore: 7 },
      { path: '/knowledge/בדיקת-דם-לאלרגיה-ילדים', titleHe: 'בדיקת דם לאלרגיה', role: 'supporting', intent: 'diagnosis', geoScore: 6 },
      { path: '/knowledge/בדיקה-חיובית-בלי-תסמינים', titleHe: 'תוצאה חיובית בלי תסמינים', role: 'supporting', intent: 'reassurance', geoScore: 7 },
      { path: '/knowledge/כמה-ימים-בין-אלרגנים', titleHe: 'כמה ימים בין אלרגנים', role: 'supporting', intent: 'treatment', geoScore: 6 },
  ...
  },
  {
    ...
    pages: [
      { path: '/knowledge/במבה-גיל-4-חודשים', titleHe: 'במבה בגיל 4 חודשים', role: 'pillar', intent: 'treatment', geoScore: 7, linksTo: ['/knowledge/פריחה-אחרי-במבה'] },
      { path: '/knowledge/פריחה-אחרי-במבה', titleHe: 'פריחה אחרי במבה', role: 'supporting', intent: 'symptom', geoScore: 7 },
      { path: '/knowledge/הקאה-אחרי-טחינה', titleHe: 'הקאה אחרי טחינה', role: 'supporting', intent: 'symptom', geoScore: 6 },
  ...
  },
  {
    ...
    pages: [
      { path: '/knowledge/במבה-גיל-4-חודשים', titleHe: 'במבה בגיל 4 חודשים', role: 'supporting', intent: 'treatment', geoScore: 7 },
      { path: '/knowledge/פריחה-אחרי-במבה', titleHe: 'פריחה אחרי במבה', role: 'supporting', intent: 'symptom', geoScore: 7 },
      { path: '/knowledge/הקאה-אחרי-טחינה', titleHe: 'הקאה אחרי טחינה', role: 'supporting', intent: 'symptom', geoScore: 6 },
      { path: '/knowledge/אודם-סביב-הפה-אחרי-אלרגן', titleHe: 'אדמומיות סביב הפה', role: 'supporting', intent: 'reassurance', geoScore: 6 },
  ...
  },
  {
    ...
    pages: [
      { path: '/knowledge/פריחה-אחרי-במבה', titleHe: 'פריחה אחרי במבה', role: 'weak', intent: 'symptom', geoScore: 5, notes: 'קשור חלקית - לא מכסה אקזמה' },
      { path: '/knowledge/אודם-סביב-הפה-אחרי-אלרגן', titleHe: 'אדמומיות סביב הפה', role: 'weak', intent: 'reassurance', geoScore: 5, notes: 'צר מדי - לא מכסה עור באופן כללי' },
  ...
  },
  {
    ...
    pages: [
      { path: '/knowledge/תבחיני-עור-כואב-לילדים', titleHe: 'האם בדיקת דקירה כואבת?', role: 'supporting', intent: 'reassurance', geoScore: 7 },
      { path: '/knowledge/בדיקת-דם-לאלרגיה-ילדים', titleHe: 'בדיקת דם לאלרגיה', role: 'supporting', intent: 'diagnosis', geoScore: 6 },
      { path: '/knowledge/תגר-מזון-איך-זה-נראה', titleHe: 'אתגר מזון אוראלי', role: 'supporting', intent: 'diagnosis', geoScore: 7 },
      { path: '/knowledge/בדיקה-חיובית-בלי-תסמינים', titleHe: 'חיובי בלי תסמינים', role: 'supporting', intent: 'reassurance', geoScore: 7 },
  ...
  },
  {
    ...
    pages: [
      { path: '/knowledge/אפיפן-בגן-מי-אחראי', titleHe: 'אחריות אפיפן', role: 'supporting', intent: 'treatment', geoScore: 5, notes: 'מכסה אחריות בלבד - לא תהליך חירום' },
  ...
  },
  {
    ...
    pages: [
      { path: '/knowledge/גן-יכול-לסרב-לילד-אלרגי', titleHe: 'סירוב גן לקבל ילד אלרגי', role: 'supporting', intent: 'reassurance', geoScore: 7 },
      { path: '/knowledge/טיול-שנתי-ילד-אלרגי', titleHe: 'טיול שנתי וילד אלרגי', role: 'supporting', intent: 'treatment', geoScore: 6 },
      { path: '/knowledge/אישור-אלרגיה-למשרד-החינוך', titleHe: 'אישור רפואי לאלרגיה', role: 'supporting', intent: 'diagnosis', geoScore: 7 },
      { path: '/knowledge/אפיפן-בגן-מי-אחראי', titleHe: 'אחריות אפיפן במסגרת', role: 'supporting', intent: 'treatment', geoScore: 5 },
  ...
  },
  {
    ...
    pages: [
      { path: '/guides/זכויות-ילד-אלרגי-ישראל', titleHe: 'מדריך זכויות ילדים אלרגיים', role: 'pillar', intent: 'definition', geoScore: 8 },
      { path: '/knowledge/סייעת-רפואית-לילד-אלרגי', titleHe: 'סייעת רפואית', role: 'supporting', intent: 'treatment', geoScore: 7 },
      { path: '/knowledge/בדיקות-אלרגיה-פרטי-או-קופה', titleHe: 'פרטי מול ציבורי', role: 'supporting', intent: 'diagnosis', geoScore: 6 },
  ...
  },
  {
    ...
    pages: [
      { path: '/knowledge/בדיקה-חיובית-בלי-תסמינים', titleHe: 'חיובי בלי תסמינים - מה עכשיו?', role: 'supporting', intent: 'reassurance', geoScore: 7 },
      { path: '/knowledge/כמה-ימים-בין-אלרגנים', titleHe: 'כמה ימים בין אלרגנים', role: 'supporting', intent: 'treatment', geoScore: 6 },
      { path: '/knowledge/תבחיני-עור-כואב-לילדים', titleHe: 'האם הבדיקה כואבת?', role: 'supporting', intent: 'reassurance', geoScore: 7 },
