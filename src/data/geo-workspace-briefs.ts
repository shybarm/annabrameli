...
export const WORKSPACE_BRIEFS: RewriteBrief[] = [
  ...
  // ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
  {
    ...
    suggestedTitle: 'מרפאת אלרגיה לילדים - ד״ר אנה ברמלי | אלרגיה ואימונולוגיה',
    suggestedMetaDescription: 'ד״ר אנה ברמלי, מומחית לאלרגיה ואימונולוגיה קלינית. אבחון וטיפול באלרגיה למזון, אסתמה אלרגית וקוצר נשימה בילדים. מרפאה פרטית - ללא המתנה.',
    answerFirstIntro: 'אבחון וטיפול באלרגיה למזון, מחלות עור אטופיות ואסתמה אלרגית, אצל ילדים ומבוגרים. כל מטופל מקבל בירור מדוקדק והתאמת תוכנית טיפול ברורה שמתאימה לו ולמשפחתו.',
